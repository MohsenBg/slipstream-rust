...
use slipstream_core::flow_control::{
    StreamReceiveConfig, StreamReceiveOps, conn_reserve_bytes, consume_error_log_message,
    handle_stream_receive, overflow_log_message,
};
    ...
    unsafe {
        ...
        match fin_or_event {
            ...
            | picoquic_call_back_event_t::picoquic_callback_stateless_reset => {
                ...
                let cnx_state = picoquic_get_cnx_state(cnx);
